...
export interface ITracksFull {
    tracks: ISearchResult<ITrack>;
}

export interface ITrackTotal {
    album: {album_type:string; artists:Array<IArtistSlim>;external_urls:any;href:string;id:string;images:Array<{ height: number; url: string; width: number }>;name:string;release_date:string;release_date_precision:string;total_tracks:number; type:string; uri:string;};
    artists: Array<IArtistSlim>;
    disc_number:number;
    duration_ms:number;
    explicit:boolean;
